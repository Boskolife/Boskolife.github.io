...
function hideCardList() {
    ...
    var cardListContent = document.querySelector(".help_content");
    var cardContent = document.querySelectorAll(".support_content");
